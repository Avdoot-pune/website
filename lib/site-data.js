...
export const featureCards = [
  ...
  },
  {
    ...
    description:
      "See why risk is rising with interpretable signals like churn, cycle time shifts, Isolation Forest anomaly flags, and urgency language.",
    icon: "drivers"
  },
  {
    title: "Actionable Mitigation Plan",
    description:
      "Move from alerting to action with ROAM classification, backlog-ready fixes, and simulated risk reduction.",
    icon: "mitigation"
  }
];
...
export const trustPoints = [
  {
    ...
    description:
      "Grounded in rule-based Agile metrics, calibrated XGBoost for known risks, Isolation Forest detection for unknown risks, and transfer testing across TensorFlow, PyTorch, and Keras."
  },
  {
    title: "Mitigation-first by design",
    description:
      "Every elevated risk can be paired with ROAM ownership, backlog-ready actions, sprint adjustments, and simulated impact."
  },
  {
